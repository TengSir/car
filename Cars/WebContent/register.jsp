...
<div class="wrap">
	...
	<div class="main">
		...
		<section class="container content clearfix">
			...
			<h3 class="widget-title">用戶注册</h3>
			
			<section class="pricing-table col4 clearfix">
				
				<div class="col" style="width: 80%">
					<form action="UserServlet?method=register" enctype="multipart/form-data"  method="post">
...
<!-- 						</dl> -->
					...
					<ul class="features">
						<li><span>账号:<input type="text"  name="username"   /></span></li>
						<li><span>密碼:<input type="password"    name="password"  /></span></li>
						<li><span>昵称:<input type="text"    name="nickname"   /></span></li>
						<li><span>性别:<input type="radio" name="sex" value="1" checked="checked"/>男
									<input type="radio" name="sex" value="0" />女</span></li>
						<li><span>年龄:
						<select name="age">
						...
						<li><span>工作:<input  type="text"   name="job"  /></span></li>
						<li><span>邮箱:<input  type="text"   name="email"  /></span></li>
						<li><span>电话:<input  type="text"   name="tel"  /></span></li>
						<li><span>驾龄:<input  type="text"   name="jialing"   /></span></li>
						<li><span>简介:<textarea name="jianjie" style="width: 160px;height: 160px;"> </textarea></span></li>
					</ul><!--/ .features -->

					<footer class="footer">
						<input type="submit" value="注册提交"   class="button orange" /><input type="reset" value="清空"   class="button orange" />
					</footer><!--/.footer -->
					</form>
				</div><!--/ .col -->
