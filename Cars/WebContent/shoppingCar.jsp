			...
			<div>
				...
				<table   style="width: 100%"  style="border:1px solid gray;" cellspacing="0">
						...
						<tr name="car">
							<td style="padding: 0px;">
								<a href="carDetail.jsp"  target="_blank">
										<img  name="img"  src="images/temp/7.jpg" align="middle" width="100" height="60" hspace="20" style="margin: auto;margin-top: 5px;"/>
								</a>
							</td>
							<td valign="middle">
							...
							<td valign="middle">
								...
								<td  valign="middle" style="padding-left: 20px;">
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=198')">
										<img src="images/add.png"  width="20" height="20" style="cursor: pointer;position: relative;top: 5px;" title="加一件"/>
									</a>
									<input type="text" value="3"  style="width: 30px;height:15px; margin-right:10px; margin-left:10px;position: relative;"/>
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=198')">
						...
						<tr name="car">
							<td style="padding: 0px;">
								<a href="carDetail.jsp"  target="_blank">
										<img  name="img"  src="images/temp/4.jpg" align="middle" width="100" height="60" hspace="20" style="margin: auto;margin-top: 5px;"/>
								</a>
							</td>
							<td valign="middle">
								<span style="font-weight: bold;font-size: 14x;">
							...
							<td valign="middle">
								...
								<td  valign="middle" style="padding-left: 20px;">
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=199')">
										<img src="images/add.png"  width="20" height="20" style="cursor: pointer;position: relative;top: 5px;" title="加一件"/>
									</a>
									<input type="text" value="1"  style="width: 30px;height:15px; margin-right:10px; margin-left:10px;position: relative;"/>
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=199')">
										<img src="images/reduce.png"  width="20" height="20" style="cursor: pointer;position: relative;top: 5px;"  title="减一件"/>
									</a>
								</td>
						...
						<tr name="car">
							<td style="padding: 0px;">
								<a href="carDetail.jsp"  target="_blank">
										<img  name="img"  src="images/temp/1.jpg" align="middle" width="100" height="60" hspace="20" style="margin: auto;margin-top: 5px;"/>
								</a>
							</td>
							<td valign="middle">
								<span style="font-weight: bold;font-size: 14x;">
							...
							<td valign="middle">
								...
								<td  valign="middle" style="padding-left: 20px;">
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=191')">
										<img src="images/add.png"  width="20" height="20" style="cursor: pointer;position: relative;top: 5px;" title="加一件"/>
									</a>
									<input type="text" value="1"  style="width: 30px;height:15px; margin-right:10px; margin-left:10px;position: relative;"/>
									<a  href="javascript:deleteCarFromGouwuche('ShoppingCarServlet?method=deleteCar&carid=191')">
...
<script>
	function deleteCarFromGouwuche(url){
		//ShoppingCarServlet?method=deleteCar&carid=
